...
from datasets import Dataset, IterableDataset, Audio, Value
...
def custom_iterable_dataset(files, language="french", sr=16000, mind=None, maxd=None, minl=None, maxl=None, clean=False, seed=None, processor=None):
    ...
    #if seed is not None:
    #    logging.info(f'dataset: shuffle(seed={seed})')
