...
if __name__ == '__main__':
    ...
    parser.add_argument('--pars', type=str, default=None, help="JSON dictionary to control training. Ex: '{\"train_strategy\": \"steps\", \"eval_steps\": 1000}' (check the train function in whisper:train() for allowed parameters)")
